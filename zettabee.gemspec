...
Gem::Specification.new do |s|
  ...
  s.description               = "Zettabee is performs incremental, block-level, asynchronous replication of remote ZFS file systems through the use of zfs send and zfs recv"
